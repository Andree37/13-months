export default function Footer() {
    return (
        <footer class="relative bg-stone-50 dark:bg-slate-950 border-t border-stone-200 dark:border-white/5 py-16 px-4 transition-colors duration-500">
            <div class="mx-auto max-w-6xl">
                <div class="text-center mb-16">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            href="#"
                            class="inline-flex items-center justify-center gap-2 rounded-full bg-indigo-600 px-8 py-3.5 text-sm font-semibold text-white transition-all hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-500/25"
                        >
                            Share this
                            <svg
                                class="w-4 h-4"
                ...
                <div class="h-px bg-linear-to-r from-transparent via-stone-300 dark:via-white/10 to-transparent mb-10" />
